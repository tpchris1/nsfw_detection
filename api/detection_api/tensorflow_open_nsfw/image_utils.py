...
def create_yahoo_image_loader_stream(expand_dims=True):
    """Modified Yahoo open_nsfw image loading mechanism
    Modified by tpchris1

    Approximation of the image loading mechanism defined in
    https://github.com/yahoo/open_nsfw/blob/79f77bcd45076b000df71742a59d726aa4a36ad1/classify_nsfw.py#L40

    The modified method uses the opened pillow image instead of file path
    """
    import numpy as np
    import skimage
    import skimage.io
